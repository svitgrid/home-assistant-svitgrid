...
def _two_inverter_entry():
    ...
    invs = [
        ...
        {"inverter_id": "ha-bbb", "entity_map": {"batterySoc": "sensor.b"}, "command_recipes": [{"id": "set_battery_charge", "service": "modbus.write_register", "args": {}}], "command_config": {"hub_name": "solarman", "slave_id": 1}, "brand": "Deye", "model": "Y", "phases": 1, "has_battery": True, "pv_strings": 1, "preset_id": None},
    ]
...
async def test_migrated_v1_entry_sets_up_without_error(hass):
    ...
    v1 = MockConfigEntry(
        ...
        data={
            "api_base": "https://api.test", "api_key": "k", "edge_device_id": "edge1",
            "hardware_id": "ha-legacy", "household_id": "hh1", "signing_key_id": "sk",
            "private_key_pem": "pem", "public_key_hex": "pub", "trusted_keys": [],
            "preset_id": None, "entity_map": {"batterySoc": "sensor.soc"},
